...
produce the lower-tail probabilities of the null distribution of $T^{+}$ . What are the possible $\alpha$
values between .05 and .10? Compare the $\alpha$ = .055 test of $H_0$ : $\theta$ = 0 versus $H_2$ : $\theta$ < 0 with the corresponding $\alpha$ = .055 test based on the large-sample approximation.

  São aceitáveis $\alpha_6 = 0,05468750$, $\alpha_7 = 0,7421875$ e $\alpha_8 = 0,09765625$. 
  
  

#Questão 10
> Apply the large-sample approximation test of H 0 : θ = 5 versus H 1 : θ > 5 based on T + to
